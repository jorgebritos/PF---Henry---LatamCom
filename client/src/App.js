...
function App() {
	...
	return (
		<div className='App'>
			...
			<PrivateRoute path='/update' component={UpdateProduct} isAllowed={userNow.admin}/>
			<PrivateRoute path='/contact/messagesended' component={messageSended} isAllowed={userNow.admin}  />
			<PrivateRoute path='/create/product' component={CreateProduct} isAllowed={isAllowed && userNow.admin} />
			<PrivateRoute path='/create/productsended' component={ProductSended} isAllowed={isAllowed && userNow.admin} />
			<PrivateRoute path="/dashboard" component={PurchasesAdmin} isAllowed={isAllowed && userNow.admin} />
			<PrivateRoute exact path='/profile' component={Profile} isAllowed={isAllowed} />
			<PrivateRoute path="/buyproducts" component={Buy} isAllowed={isAllowed && !userNow.admin} />
			<PrivateRoute path="/SuccessPayment" component={SuccessedPayment} isAllowed={isAllowed && !userNow.admin} />
			<PrivateRoute path='/cancelpayment' component={CancelPayment} isAllowed={isAllowed && !userNow.admin} />
			<PrivateRoute exact path="/profile/changedata" component={UpdateProfile} isAllowed={isAllowed} />
			<PrivateRoute path="/profile/success" component={Success} isAllowed={isAllowed} />
